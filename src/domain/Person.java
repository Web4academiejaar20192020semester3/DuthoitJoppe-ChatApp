...
public class Person {
    ...
    private String gelacht;
    private int leeftijd;
    private Role role;
    private String status;
    private List<Person> friends;
    private String message;
    private boolean ageBericht;

    public Person(String voornaam, String naam, String userId, String geslacht, String password, int leeftijd) {
    ...
    public void setGelacht(String gelacht) {
        this.gelacht = gelacht;
    }
    ...
    public boolean getBoolean() {
        return this.ageBericht;
    }

    public void setBoolean(boolean ageBericht) {
        this.ageBericht = ageBericht;
    }
}
