...
//		Person administrator = new Person("bib@ucll.be", "t", "Bib", "Liothekaris", Role.BIB);
		Person administrator = new Person("Bib", "Liothekaris", "bib@ucll.be", "M", "t", 20);
		administrator.setRole(Role.BIB);
		administrator.setStatus("offline");
		add(administrator);
//		Person jan = new Person("jan@ucll.be", "t", "Jan", "Janssens", Role.LID);
		Person jan = new Person("Jan", "Janssens", "jan@ucll.be", "M", "t", 20);
		jan.setStatus("offline");
		add(jan);
//		Person an = new Person("an@ucll.be", "t", "An", "Cornelissen", Role.LID);
		Person an = new Person("An", "Cornelissen", "an@ucll.be", "V", "t", 20);
